...
subroutine INSERT_SET_INTERATOMIC_POTENTIALS(icanal,IFILE,IINSREM,ILOCAL_INSERTS)
...
!   ***********************************************************************************************
    ...
    integer (kind=4), intent(in) :: icanal, IFILE, IINSREM, ILOCAL_INSERTS;
...
!   ### Write the title of the routine #############################################################
                                                                                         !
    CHTITLE = 'Set Interatomic Potentials (insert)';                                     !
                                                                                         !
...
!   stop; !//////////////////////////////////////////////////////////////////////////////!
                                                                                         !
!   ### Write the number of the insert command to consider #########################################
                                                                                         !
    write(icanal,'(a19,i4,a47)') '| Insert command # ', &                                !
                                 ILOCAL_INSERTS,        &                                !
                                 REPEAT(' ',46)//'|';                                    !
                                                                                         !
    write(icanal,'(a70)') '|'//REPEAT(' ',68)//'|';                                      !
...
!   stop; !//////////////////////////////////////////////////////////////////////////////!
                                                                                         !
!   ### Write the number of modifications to apply for the current insert command ##################
                                                                                         !
    write(icanal,'(a37,i4,a29)') '| Number of modifications to apply # ', &              !
...
!   stop; !//////////////////////////////////////////////////////////////////////////////!
    ...
    if ( LAMMPS_INSERT_IPOTENTIAL_CLASS2 == 1 ) then;                                    !
                                                                                         !
        POTENTIAL_CLASS2_CHTYPE_LIBRARY(IFILE) =               &                         !
...
!   stop; !//////////////////////////////////////////////////////////////////////////////!
                                                                                         !    
!   ### Modify pair potentials parameters for same atoms ###########################################
                                                                                         !
    if ( LAMMPS_INSERT_IPOTENTIAL_CLASS2 == 1 ) then;                                    !
                                                                                         !
        IPOTENTIAL_CLASS2_LIBRARY(IFILE) = 1;                                            !
                                                                                         !   
        do i = 1, LAMMPS_INSERT_NMODIFIED(ILOCAL_INSERTS);                               !
                                                                                         !
            select case(TRIM(LAMMPS_INSERT_MODIFY_STYLE(i,ILOCAL_INSERTS)));             !
                                                                                         !
                case('pair_coeff');                                                      !
                                                                                         !
                    CHOSEF1 = &                                                          !
                    TRIM(LAMMPS_INSERT_POTENTIAL_CLASS2_NAT(1,i,ILOCAL_INSERTS));        !
                                                                                         !
                    CHOSEF2 = &                                                          !
                    TRIM(LAMMPS_INSERT_POTENTIAL_CLASS2_NAT(2,i,ILOCAL_INSERTS));        !
                                                                                         !
                    if ( TRIM(CHOSEF1) /= TRIM(CHOSEF2) ) CYCLE;                         !
                                                                                         !
                    select case(NTYPE_ATOM_LIBRARY(IFILE));                              !
                                                                                         !
                        case(1);                                                         !
                                                                                         !
                            POTENTIAL_CLASS2_LIBRARY(1:2,1,IFILE) =               &      !
                            LAMMPS_INSERT_POTENTIAL_CLASS2(1:2,i,ILOCAL_INSERTS);        !
                                                                                         !
                        case default;                                                    !
                                                                                         !
...
!   stop; !//////////////////////////////////////////////////////////////////////////////!
                                                                                         !
end subroutine INSERT_SET_INTERATOMIC_POTENTIALS
