...
subroutine UPDATE_PARAMETER_ARRAY(icanal,                 &
                                  NTYPE_ATOM_TMP,         &
                                  NTYPE_BOND_TMP,         &
                                  NTYPE_ANGLE_TMP,        &
                                  NTYPE_DIHEDRAL_TMP,     &
...
!   ************************************************************************************************
    ...
    if ( NTYPE_ATOM_TMP > 0 ) then;                                                      !
                                                                                         !
        ATOM_LABEL(1:NTYPE_ATOM_TMP) = ATOM_LABEL_OLD(1:NTYPE_ATOM_TMP);                 !
                                                                                         !
        ATOM_MASSE(1:NTYPE_ATOM_TMP) = ATOM_MASSE_OLD(1:NTYPE_ATOM_TMP);                 !
                                                                                         !
...
!   stop; !//////////////////////////////////////////////////////////////////////////////!
    ...
    if ( NTYPE_BOND_TMP > 0 )  then;                                                     !
                                                                                         !
        BOND_COEFFS(1:4,1:NTYPE_BOND_TMP) = BOND_COEFFS_OLD(1:4,1:NTYPE_BOND_TMP);       !
                                                                                         !
    end if                                                                               !
                                                                                         !
!   stop; !//////////////////////////////////////////////////////////////////////////////!
...
!   stop; !//////////////////////////////////////////////////////////////////////////////!
                                                                                         !
end subroutine UPDATE_PARAMETER_ARRAY
